...
class Weight_Fix_Base(pl.LightningModule):
    ...
    def __init__(self):
        ...
        self.vaccuracy = metrics.Accuracy(task = 'multiclass', num_classes = 1000)
        self.ttaccuracy = metrics.Accuracy(task = 'multiclass', num_classes = 1000)
        # the top 5 accuracy
        self.ttaccuracy5 = metrics.Accuracy(task = 'multiclass', num_classes = 1000, top_k = 5)
